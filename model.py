...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=100, use_bn=True):
        super(ResNet, self).__init__()
        self.in_planes = 64
        self.use_bn = use_bn

        # CIFAR-100 optimization: small kernel and no maxpool at start
...
def ResNet18(num_classes=100, use_bn=True):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, use_bn)